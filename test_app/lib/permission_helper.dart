...
class Permissions {
  static void checkPermissions({
    ...
    var permanentlyDenied = statuses.entries.where((element) => element.value.isPermanentlyDenied).map((e) => e.key).toList();
    var denied = statuses.entries.where((element) => element.value.isDenied).map((e) => e.key).toList();
